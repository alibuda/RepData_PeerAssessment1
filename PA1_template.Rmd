...
```
So,the mean is `r meanstep.per.day`, median is `r medianstep.per.day`.
...
```
The 5-minute interval contains the maximum number of steps, on average across all the days in the dataset, is `r max.inv`.
...
```
The mean is `r meanstep.per.day.n`, median is `r medianstep.per.day.n`.
